		...
		<ValidationObserver ref="form">
			<v-card>
				<div class="blue-grey lighten-4">
					<v-card-title>Create Salesman</v-card-title>
				</div>
				<v-divider></v-divider>
				<div class="px-5">
					...
					<v-row class="px-5">
						<v-col sm="6" cols="12">
							...
							<validation-provider name="Salesman Name" rules="required|min:3" v-slot="{ errors }">
								<v-text-field outlined solo dense label="Salesman Name" v-model="form.name" required></v-text-field>
